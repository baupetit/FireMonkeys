...
//    glEnable(GL_DEPTH_TEST);
    ...
    shadoudoudoudoudoulolptdrMDRXD = new Shader("./Shaders/feu.vert","./Shaders/feu.frag");

    GLuint	location = glGetUniformLocation ( shadoudoudoudoudoulolptdrMDRXD->getProgramId(), "feu");
