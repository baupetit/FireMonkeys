...
public:
    ...
    Texture(int width,int height,GLuint target = TEXTURE_2D,
                    int flag = RGB | LINEAR_MIPMAP_LINEAR, void* data = NULL);
    ...
    void enable(int unit,Texture *old = NULL);
    void disable(int unit);
    void bind(int unit,Texture *old = NULL);
