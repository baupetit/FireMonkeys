...
struct vec2 {
    ...
    inline const vec2 operator/(float f) const { float vf = 1.0/f; return vec2(x * vf,y * vf); }
...
struct vec3 {
    ...
    inline const vec3 operator/(float f) const { float vf = 1.0/f; return vec3(x * vf,y * vf,z * vf); }
...
struct vec4 {
    ...
    inline const vec4 operator/(float f) const { float vf = 1.0/f; return vec4(x * vf,y * vf,z * vf,w * vf); }
