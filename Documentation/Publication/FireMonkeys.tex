...
\item{La diffusion~:}\\ 
  ...
  \textvf{Gauss-Seidel} nous permet de considérer une méthode stable, même pour
...
\textvf{coefficient de refroidissement} qui fait baisser la température lorsque
...
\includegraphics[scale=0.4]{Perlin1.ps}
\includegraphics[scale=0.4]{Perlin2.ps}
