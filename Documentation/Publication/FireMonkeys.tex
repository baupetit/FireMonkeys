...
\subsubsection{Adaptated Physics Based Tetrahedral Mesh Generation Using Level Sets}
...
\textbf{Point(s) négatif(s)} :\\
	...
	Le feu n'est pas adapté à plusieurs cas de figures.\\
\textbf{Conclusion} :\\
	La bonne idée de transformer une particule de feu en fumée à partir d'un tirage aléatoire est une bonne idée.
	Sinon, l'utilisation de particules pour simuler une mécanique peut suffire pour un simple effet mais pas pour une 		simulation réaliste.
